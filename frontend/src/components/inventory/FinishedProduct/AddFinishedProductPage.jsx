      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <nav className="mt-4" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm text-primary-600">
              ...
              <li>
                <span className="text-primary-900 font-medium">Añadir Producto Terminado</span>
              </li>
            </ol>
          </nav>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-primary-600 max-w-2xl mx-auto">
            Registre un nuevo producto terminado en el sistema de inventario completando todos los campos requeridos.
          </p>
        </div>

        {/* Form Component */}
        <AddFinishedProductForm onFinishedProductAdded={handleFormSubmitSuccess} />
      </div>
    </div>
  );
}
