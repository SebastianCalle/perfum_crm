...
function AddAlcoholForm({ onAlcoholAdded }) {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg border border-primary-200 p-8">
      <div className="mb-8">
        <h3 className="text-2xl font-bold text-primary-900 mb-2">Añadir Nuevo Alcohol</h3>
        <p className="text-primary-600">Complete los campos para registrar un nuevo tipo de alcohol en el inventario.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Nombre */}
          <div>
            <label htmlFor="alcoholName" className="block text-sm font-semibold text-primary-900 mb-2">
              Nombre (Tipo) <span className="text-red-500">*</span>
            </label>
            <input
              id="alcoholName"
              type="text"
          ...
          {/* Proveedor */}
          <div>
            <label htmlFor="alcoholSupplierName" className="block text-sm font-semibold text-primary-900 mb-2">
              Proveedor
            </label>
            <input
              id="alcoholSupplierName"
              type="text"
              value={supplierName}
              onChange={(e) => setSupplierName(e.target.value)}
              className="w-full px-4 py-3 border border-primary-200 rounded-lg focus:ring-2 focus:ring-primary-600 focus:border-primary-600 transition-colors placeholder-primary-300"
              placeholder="Ej: Químicos Industriales SA"
            />
          </div>

          {/* Fecha de Compra */}
          <div>
            <label htmlFor="alcoholPurchaseDate" className="block text-sm font-semibold text-primary-900 mb-2">
              Fecha de Compra
            </label>
            <input
              id="alcoholPurchaseDate"
              type="date"
              value={purchaseDate}
          ...
          {/* Volumen Unitario */}
          <div>
            <label htmlFor="alcoholPurchaseUnitVolumeMl" className="block text-sm font-semibold text-primary-900 mb-2">
              Volumen Unitario (ml) <span className="text-red-500">*</span>
            </label>
            <input
              id="alcoholPurchaseUnitVolumeMl"
              type="number"
              step="0.01"
        ...
        <div>
          <label htmlFor="alcoholDescription" className="block text-sm font-semibold text-primary-900 mb-2">
            Descripción
          </label>
          <textarea
            id="alcoholDescription"
            value={description}
            ...
            placeholder="Descripción del tipo de alcohol..."
          />
        </div>

        {/* Campos de costo y notas */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Costo Unitario */}
          <div>
            <label htmlFor="alcoholPurchaseUnitCost" className="block text-sm font-semibold text-primary-900 mb-2">
              Costo Unitario <span className="text-red-500">*</span>
            </label>
            <div className="relative">
              <span className="absolute left-3 top-3 text-primary-600 font-medium">$</span>
              <input
                id="alcoholPurchaseUnitCost"
                type="number"
                step="0.01"
          ...
          {/* Notas de Stock - Campo completo en grid */}
          <div>
            <label htmlFor="alcoholStockNotes" className="block text-sm font-semibold text-primary-900 mb-2">
              Notas de Stock
            </label>
            <textarea
              id="alcoholStockNotes"
              value={stockNotes}
              onChange={(e) => setStockNotes(e.target.value)}
              rows={3}
              className="w-full px-4 py-3 border border-primary-200 rounded-lg focus:ring-2 focus:ring-primary-600 focus:border-primary-600 transition-colors placeholder-primary-300 resize-none"
              placeholder="Notas adicionales sobre el stock..."
            />
          </div>
        </div>
